...
const anita_config = {
    ...
    socials: {
        'facebook' : {
            'url': 'https://www.facebook.com/StoryXWeb',
            'label': 'Fb.'
        },
        'twitter' : {
            'url': 'https://twitter.com/storyx_uk',
            'label': 'X.'
        },
        'instagram' : {
            'url': 'https://www.instagram.com/the_storyx',
            'label': 'In.'
        },
        'LinkedIn' : {
            'url': 'https://www.linkedin.com/company/the-storyx',
            'label': 'Li.'
        },
    },
    ...
    l10n: {
        ...
        copyright: 'Copyright &copy; 2023 | StoryX | All Rights Reserved.',
